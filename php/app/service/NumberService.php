...
class NumberService
{
    public function getNumbers(string $productId, int $limit, int $offset): array
    {
        /*$connection = \Yii::$app->dbSwMaster->createCommand("
            SELECT ab.fiabonent_id as abonent_id, aa.fiapp_profile_id as profile_id, aa.fsnumber as number, c.fsschema_name as schema_name, c.fipoint_fwd_schema_id as schema_id
        ...
        return [
            [
                'number' => '7(495)660-83-15',
                'schema_name' => 'Копия al2(1)',
                'schema_id' => '1333',
            ],
            [
                'number' => '7(495)660-83-15',
