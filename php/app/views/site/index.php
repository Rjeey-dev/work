...
<div class="content-wrapper">
    <div class="left-panel">
        ...
        <div class="widgets-wrapper">
            <div class="widgets-site">
                <p class="widgets-site_sites">Виджеты для сайта</p>
                <a href="#">Test MCW</a>
                <a href="#">PRO</a>
                <a href="#">Mysite.ru</a>
            </div>
    ...
    <div class="left-panel">
        ...
        <div class="numbers-buy">
            <div class="num-buy">
                <p class="numbers-buy_number_our_operator title">Группы</p>
                <a class="item" href="#">Новая группа</a>
                <a class="item" href="#">ГруппаПро</a>
                <a class="item" href="#">!!!!ARMANDELA</a>
            </div>
            <div class="connect">
                <a class="title" href="#">распределение звонков</a>
                <div class="con-wrapper">
                    <p class="item">"Последовательный"</p>
                    <p class="item">"Одновременно всем"</p>
                    <p class="item">"Последовательный"</p>
                </div>
            </div>
        </div>
        <div class="numbers-buy">
            <div class="num-buy">
                <p class="numbers-buy_number_our_operator title">Интеграции</p>
                <a class="item" href="#">API:Возможность использовать API-конструктор</a>
                <a class="item" href="#">API:Интеграция с amoCRM</a>
            </div>
            <div class="connect">
                <a class="title" href="#">Подключить</a>
