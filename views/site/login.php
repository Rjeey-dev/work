...
$this->registerCssFile('/basic/web/css/login.css');
$this->registerCssFile('/basic/web/assets/e7976eb/css/bootstrap.css');
...
<div class="forms">
    <div class="login-form">
        <div class="left-form">
            <div class="logo">
                <a  href="#"> <img class="mango_png" src="/basic/web/img/logo.png"></a>
